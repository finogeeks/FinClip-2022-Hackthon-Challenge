...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"exam","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 18:
/*!*****************************************************!*\
  !*** C:/Learn/php/exam/view/exam/common/js/auth.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {var _config = _interopRequireDefault(__webpack_require__(/*! ./config.js */ 19));
var _urls = _interopRequireDefault(__webpack_require__(/*! ./urls.js */ 20));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

function check() {
  // 获取token
  var token = uni.getStorageSync(_config.default.storageCode.loginToken);
  uni.request({
    url: _config.default.baseUrl + _urls.default.auth.checkLogin,
    ...
    success: function success(res) {
      ...
      if (res.data.errCode == _config.default.requestCode.loginTimeOut) {
        Login();
      }
    },
...
function Login() {
  var terminal = _config.default.terminal;
  switch (terminal) {
    case "weixin":
...
{
  // 保存token
  uni.setStorageSync(_config.default.storageCode.loginToken, '');
  uni.reLaunch({
    url: '/pages/login/index' });
...
function accountPasswordLogin(params)
{
  ...
  uni.request({
    url: _config.default.baseUrl + _urls.default.auth.aplogin,
    ...
    success: function success(res) {
      ...
      var ret = res.data;
      if (ret.errCode != _config.default.requestCode.ok) {
        uni.showToast({ title: ret.errMsg, icon: 'none' });
        return;
      }
      // 保存token
      uni.setStorageSync(_config.default.storageCode.loginToken, ret.data.token);
      successCallback();
    },
    fail: function fail(res) {
      uni.showToast({ title: '网络异常', icon: 'none' });
...
function accountPasswordRegistered(params)
{
  var successCallback = params.success;
  uni.request({
    url: _config.default.baseUrl + _urls.default.auth.apRegistered,
    header: { 'content-type': 'application/json', 'Authorization': '' },
    method: 'post',
    data: JSON.stringify({
      account: params.account,
    ...
    success: function success(res) {
      ...
      if (res.data.errCode != _config.default.requestCode.ok) {
...
function ttMiniProgramLogin(callback) {
  uni.login({
    ...
    success: function success(loginRes) {
      get({
        url: _urls.default.auth.ttlogin + "?code=" + loginRes.code,
        success: function success(res) {
          // 保存token
          uni.setStorageSync(_config.default.storageCode.loginToken, res.token);
          callback();
        } });
...
function wxMiniProgramLogin(callback) {
  uni.login({
    ...
    success: function success(loginRes) {
      get({
        url: _urls.default.auth.wxlogin + "?code=" + loginRes.code,
        success: function success(res) {
          // 保存token
          uni.setStorageSync(_config.default.storageCode.loginToken, res.token);
          callback();
...
/***/ 19:
/*!*******************************************************!*\
  !*** C:/Learn/php/exam/view/exam/common/js/config.js ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  ...
  storageCode: {
    ...
    TemporaryGroupChatMessage: "TemporaryGroupChatMessage" } };exports.default = _default;
...
/***/ 20:
/*!*****************************************************!*\
  !*** C:/Learn/php/exam/view/exam/common/js/urls.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = {
  ...
  knowledge: {
    list: "/knowledge/list",
    detail: "/knowledge/detail" } };exports.default = _default;

/***/ }),

/***/ 21:
/*!*****************************************************!*\
  !*** C:/Learn/php/exam/view/exam/common/js/exam.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _urls = _interopRequireDefault(__webpack_require__(/*! ./urls.js */ 20));
var _http = _interopRequireDefault(__webpack_require__(/*! ./http.js */ 22));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

function callBoardList(successCallback)
{
  _http.default.post({
    url: _urls.default.callBoard.list,
...
{
  _http.default.post({
    url: _urls.default.course.learn,
    data: data,
    success: successCallback });
...
{
  _http.default.post({
    url: _urls.default.course.detail,
    data: data,
    success: successCallback });
...
{
  _http.default.post({
    url: _urls.default.course.courseware,
    data: data,
    success: successCallback });
...
{
  _http.default.post({
    url: _urls.default.exam.question,
    data: data,
    success: successCallback });
...
{
  _http.default.post({
    url: _urls.default.knowledge.list,
    data: data,
    success: successCallback });
...
{
  _http.default.post({
    url: _urls.default.knowledge.detail,
    data: data,
    success: successCallback });
...
/***/ 22:
/*!*****************************************************!*\
  !*** C:/Learn/php/exam/view/exam/common/js/http.js ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {var _regenerator = _interopRequireDefault(__webpack_require__(/*! ./node_modules/@babel/runtime/regenerator */ 23));var _config = _interopRequireDefault(__webpack_require__(/*! ./config.js */ 19));
var _urls = _interopRequireDefault(__webpack_require__(/*! ./urls.js */ 20));
var _auth = _interopRequireDefault(__webpack_require__(/*! ./auth.js */ 18));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}
//网络请求
...
//网络请求
var wxRequest = function wxRequest(method, params) {
...
var post = function post(params, isSync) {
  if (isSync) {var
    request = /*#__PURE__*/function () {var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (
                  wxRequest('POST', params));case 2:case "end":return _context.stop();}}}, _callee);}));return function request() {return _ref.apply(this, arguments);};}();
...
/***/ 233:
/*!***************************************************************************************!*\
  !*** C:/Learn/php/exam/view/exam/uni_modules/uni-icons/components/uni-icons/icons.js ***!
  \***************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 248:
/*!***************************************************************************************!*\
  !*** C:/Learn/php/exam/view/exam/uni_modules/uni-popup/components/uni-popup/popup.js ***!
  \***************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 249:
/*!********************************************************************************************!*\
  !*** C:/Learn/php/exam/view/exam/uni_modules/uni-popup/components/uni-popup/i18n/index.js ***!
  \********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 250:
/*!*******************************************************************************************!*\
  !*** C:/Learn/php/exam/view/exam/uni_modules/uni-popup/components/uni-popup/i18n/en.json ***!
  \*******************************************************************************************/
...
/***/ 251:
/*!************************************************************************************************!*\
  !*** C:/Learn/php/exam/view/exam/uni_modules/uni-popup/components/uni-popup/i18n/zh-Hans.json ***!
  \************************************************************************************************/
/*! exports provided: uni-popup.cancel, uni-popup.ok, uni-popup.placeholder, uni-popup.title, uni-popup.shareTitle, default */
/***/ (function(module) {
...
/***/ 252:
/*!************************************************************************************************!*\
  !*** C:/Learn/php/exam/view/exam/uni_modules/uni-popup/components/uni-popup/i18n/zh-Hant.json ***!
  \************************************************************************************************/
/*! exports provided: uni-popup.cancel, uni-popup.ok, uni-popup.placeholder, uni-popup.title, uni-popup.shareTitle, default */
/***/ (function(module) {
...
/***/ 265:
/*!******************************************************************************************************!*\
  !*** C:/Learn/php/exam/view/exam/uni_modules/uni-search-bar/components/uni-search-bar/i18n/index.js ***!
  \******************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _en = _interopRequireDefault(__webpack_require__(/*! ./en.json */ 266));
var _zhHans = _interopRequireDefault(__webpack_require__(/*! ./zh-Hans.json */ 267));
var _zhHant = _interopRequireDefault(__webpack_require__(/*! ./zh-Hant.json */ 268));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
{
  en: _en.default,
  'zh-Hans': _zhHans.default,
  'zh-Hant': _zhHant.default };exports.default = _default;
...
/***/ 266:
/*!*****************************************************************************************************!*\
  !*** C:/Learn/php/exam/view/exam/uni_modules/uni-search-bar/components/uni-search-bar/i18n/en.json ***!
  \*****************************************************************************************************/
...
/***/ 267:
/*!**********************************************************************************************************!*\
  !*** C:/Learn/php/exam/view/exam/uni_modules/uni-search-bar/components/uni-search-bar/i18n/zh-Hans.json ***!
  \**********************************************************************************************************/
/*! exports provided: uni-search-bar.cancel, uni-search-bar.placeholder, default */
/***/ (function(module) {
...
/***/ 268:
/*!**********************************************************************************************************!*\
  !*** C:/Learn/php/exam/view/exam/uni_modules/uni-search-bar/components/uni-search-bar/i18n/zh-Hant.json ***!
  \**********************************************************************************************************/
/*! exports provided: uni-search-bar.cancel, uni-search-bar.placeholder, default */
/***/ (function(module) {
...
/***/ 319:
/*!**************************************************************!*\
  !*** C:/Learn/php/exam/view/exam/pages.json?{"type":"stat"} ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _en_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./en.json */ 321);
var _en_json__WEBPACK_IMPORTED_MODULE_0___namespace = /*#__PURE__*/__webpack_require__.t(/*! ./en.json */ 321, 1);
/* harmony import */ var _es_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./es.json */ 322);
var _es_json__WEBPACK_IMPORTED_MODULE_1___namespace = /*#__PURE__*/__webpack_require__.t(/*! ./es.json */ 322, 1);
/* harmony import */ var _fr_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./fr.json */ 323);
var _fr_json__WEBPACK_IMPORTED_MODULE_2___namespace = /*#__PURE__*/__webpack_require__.t(/*! ./fr.json */ 323, 1);
/* harmony import */ var _zh_Hans_json__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./zh-Hans.json */ 324);
var _zh_Hans_json__WEBPACK_IMPORTED_MODULE_3___namespace = /*#__PURE__*/__webpack_require__.t(/*! ./zh-Hans.json */ 324, 1);
/* harmony import */ var _zh_Hant_json__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./zh-Hant.json */ 325);
var _zh_Hant_json__WEBPACK_IMPORTED_MODULE_4___namespace = /*#__PURE__*/__webpack_require__.t(/*! ./zh-Hant.json */ 325, 1);
...
/***/ 331:
/*!****************************************************************************************************!*\
  !*** C:/Learn/php/exam/view/exam/uni_modules/uni-load-more/components/uni-load-more/i18n/index.js ***!
  \****************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 332:
/*!***************************************************************************************************!*\
  !*** C:/Learn/php/exam/view/exam/uni_modules/uni-load-more/components/uni-load-more/i18n/en.json ***!
  \***************************************************************************************************/
...
/***/ 333:
/*!********************************************************************************************************!*\
  !*** C:/Learn/php/exam/view/exam/uni_modules/uni-load-more/components/uni-load-more/i18n/zh-Hans.json ***!
  \********************************************************************************************************/
/*! exports provided: uni-load-more.contentdown, uni-load-more.contentrefresh, uni-load-more.contentnomore, default */
/***/ (function(module) {
...
/***/ 334:
/*!********************************************************************************************************!*\
  !*** C:/Learn/php/exam/view/exam/uni_modules/uni-load-more/components/uni-load-more/i18n/zh-Hant.json ***!
  \********************************************************************************************************/
/*! exports provided: uni-load-more.contentdown, uni-load-more.contentrefresh, uni-load-more.contentnomore, default */
/***/ (function(module) {
...
/***/ 349:
/*!***********************************************************************************************************!*\
  !*** C:/Learn/php/exam/view/exam/uni_modules/uni-transition/components/uni-transition/createAnimation.js ***!
  \***********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ 387:
/*!*******************************************************!*\
  !*** C:/Learn/php/exam/view/exam/common/js/common.js ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/***/ 5:
/*!**********************************************!*\
  !*** C:/Learn/php/exam/view/exam/pages.json ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports) {
