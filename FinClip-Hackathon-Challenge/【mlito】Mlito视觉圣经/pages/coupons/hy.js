...
vip_bt(e){
  ...
  if(id==2){
    this.setData({
      money : "299",
      nextAction : '{"type":6,"userLevelPriceId":"232","isAutoRenew":true,"remark":"个人版"}',
      payName : "个人版",
      remark :  "个人版",
      token :  wx.getStorageSync('token')
    })
  ...
  if(id==3){
    this.setData({
      money : "699",
      nextAction : '{"type":6,"userLevelPriceId":"233","isAutoRenew":true,"remark":"品牌版"}',
      payName : "品牌版",
      remark :  "品牌版",
      token :  wx.getStorageSync('token')
    })
...
// payName: "提升版"
// remark: "提升版"
// token: "d4885bb6-588c-4ec4-80cb-bbc1f2a731cf"
