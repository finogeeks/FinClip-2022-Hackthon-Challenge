...
Page({
  ...
  go_brand(e) {
    ...
    wx.navigateTo({
      url: '/pages/goods/list?brandId=' + id,
    })
  ...
  onLoad(e) {
    ...
    console.log("goodsDetailSkuShowTypegoodsDetailSkuShowTypegoodsDetailSkuShowTypegoodsDetailSkuShowType",this.data.goodsDetailSkuShowType);
    this.readConfigVal()
  ...
  async getGoodsDetailAndKanjieInfo(goodsId) {
    ...
    if (goodsDetailRes.code == 0) {
      ...
      if (goodsDetailRes.data.basicInfo.videoId) {
        ...
        if( goodsDetailRes.data.extJson){

          if(goodsDetailRes.data.extJson.服务){
            var jtag1 = goodsDetailRes.data.extJson.服务
            jtag1 = jtag1.split("、");
          }

          if(goodsDetailRes.data.basicInfo.tags){
            var jtag2 = goodsDetailRes.data.basicInfo.tags
            jtag2 = jtag2.split("、");
          }
      ...
      console.log("jtag1jtag1jtag1",jtag1);
      let _data = {
        goodsDetail: goodsDetailRes.data,
        fbt:goodsDetailRes.data.extJson.副标题,
        jtag1: jtag1,
        jtag2: jtag2,
        selectSizePrice: goodsDetailRes.data.basicInfo.minPrice,
        selectSizeOPrice: goodsDetailRes.data.basicInfo.originalPrice,
    ...
    console.log("信息：",that.data.goodsDetail);
  },
