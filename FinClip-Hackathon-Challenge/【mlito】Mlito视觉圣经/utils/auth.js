...
async function checkSession(){
  console.log("234324checkSession");
...
async function checkHasLogined() {
  ...
  console.log("checkHasLogined234324324",wx.getStorageSync('token'));
  console.log("2343243243242");
  const token = wx.getStorageSync('token')
  if (!token) {
    return false
  }
