...
var API_BASE_URL = 'https://apis.mlito.com';
...
module.exports = {
  ...
  //mlito
  mlito_posts: (id) => {
    return request2('/wp-json/wp/v2/posts/'+id, true, 'get')
  },
  mlito_shuoyou_list: (id) => {
    return request2('/wp-json/wp/v2/posts?'+id, true, 'get')
  },
  mlito_taglist: (id) => {
    return request2('/wp-json/wp/v2/tags?'+id, true, 'get')
  },
