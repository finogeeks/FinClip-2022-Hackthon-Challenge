...
Page({
    ...
    neijing:function(i){
        ...
        // 小主题
            ...
            for(var a = xzt_sl; a >= 1; a--) { // 这里的i是代表数组的下标
    ...
    onShareAppMessage: function() {
        return {
            title: "haybirds儿童摄影",
            path: "/pages/product-detail/product-detail?category_id=99029&type=wj"
        };
        console.log("/pages/product-detail/product-detail?category_id=99029&type=wj");
    },
