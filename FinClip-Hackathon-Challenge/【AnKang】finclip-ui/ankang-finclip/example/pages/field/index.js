...
Page(Object.assign({}, Finclip.Field, {
  data: {
    config,
    value: 'test',
  ...
  handleFinclipFieldChange(e) {
    const { componentId, detail } = e;

    console.log('[finclip:field:change]', componentId, detail);
  },

  handleFinclipFieldFocus(e) {
    const { componentId, detail } = e;

    console.log('[finclip:field:focus]', componentId, detail);
  },

  handleFinclipFieldBlur(e) {
    const { componentId, detail } = e;

    console.log('[finclip:field:blur]', componentId, detail);
  },
  ...
  formReset(event) {
    console.log('[finclip:field:reset]', event);
  },
