<template>
	<view class="user-list">
		<view bindtap="onUserClick" class="user-item" v-for="(item,index) in user" :key="index">
			<image class="avatars" mode="aspectFill" :src="item.avatarUrl"></image>
			<view class="infos">
				<view class="titles">
					<view class="nickname">
			...
			<button class="follow-btn">{{!item.status?'+关注':'已关注'}}</button>
		</view>
	</view>
</template>
